...
//GameStatus = "start" agora o valor de GameStaus vai ser "start"

//GameStatus == "start" to perguntando se o valor de GameStatus é "start"
...
function game(){
  ...
  if(gameConfig.status==='gameover'){
    ...
    textSize(15);
    text("Pressione jogar para recomeçar", gameConfig.screenX/2, gameConfig.screenY/2+135);
    textSize(40);
...
function changeGameStatud(character){
  ...
  if(gameConfig.status==="gameover" && GameStatus == "start") {
